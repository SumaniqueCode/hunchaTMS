        ...
        <div className="">
            <div className="navbar grid grid-cols-8 md:grid-cols-12 bg-blue-600">
                <div className="flex justify-center p-2 text-white text-lg col-span-2 md:col-span-1 my-auto">
                    <NavLink to="/dashboard" className="logo"><img className="w-12" src={Logo} /></NavLink>
                </div>
                <div className="flex justify-start p-2 pe-12 text-white text-lg col-span-6 md:col-span-6 my-auto">
                    <NavLink to="/dashboard" className=" hover:bg-white hover:text-black hover:font-bold p-1 mx-2 rounded">Home</NavLink>
                    <NavLink to="/allProjects" className="hover:bg-white hover:text-black hover:font-bold p-1 mx-2 rounded">All Projects</NavLink>
                    <NavLink to="/myProjects" className="hover:bg-white hover:text-black hover:font-bold mx-2 p-1 rounded">My Projects</NavLink>
                </div>
