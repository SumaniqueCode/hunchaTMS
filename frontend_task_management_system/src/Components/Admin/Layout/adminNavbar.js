...
<div className="bg-blue-600">
      <div className="container mx-auto relative flex items-center p-2 text-lg">
        <div className="flex items-center mx-8">
          <NavLink to="/admin" className="logo"><img className="w-12" src={Logo} alt="Logo" /></NavLink>
        </div>
        <div className="hidden md:flex space-x-4 mx-4 gap-1">
          <NavLink to="/admin" className="text-white hover:bg-white hover:text-black hover:font-bold mx-2 p-1 rounded">Home</NavLink>
          <NavLink to="/adminProjects" className="text-white hover:bg-white hover:text-black hover:font-bold mx-2 p-1 rounded">All Projects</NavLink>
          <NavLink to="/users" className="text-white hover:bg-white hover:text-black hover:font-bold mx-2 p-1 rounded">Users</NavLink>
        </div>
